...
for valor in valores:
  print(f"0 imposto de {valor} é {calcular_imposto_aliquota(valor)}")

for valor in valores:
  print(f"0 imposto de {valor} é {calcular_imposto_aliquota(valor, 7)}")

#E se agora o imposto for 10$?
for valor in valores:
  print(f"0 imposto de {valor} é {calcular_imposto_aliquota(valor, 10)}")
